<template>
  <div class="desk" :class="deskStyle" @click="() => $emit('click')">
    <div class="desk__icon">
      <svg v-if="isMelee" class="icon" :class="iconStyle" width="88px" height="88px" viewBox="0 0 512 512"
...
export default {
  ...
  computed: {
    ...
    deskStyle() {
      return this.generateStyleByType('desk');
    },
  },
}
</script>
