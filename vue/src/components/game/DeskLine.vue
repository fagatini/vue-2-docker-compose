<template>
  <div class="desk-line" :class="deskLineStyle" @click="() => $emit('click')">
    <div class="desk-line__icon">
      <svg v-if="isMelee" class="icon" :class="iconStyle" width="88px" height="88px"
      ...
      <svg v-else class="icon" :class="iconStyle" width="80px" height="80px" version="1.1" id="Layer_1"
...
export default {
  ...
  computed: {
    ...
    iconStyle() {
      return this.generateStyleByType('icon');
    },
    deskLineStyle() {
      return this.generateStyleByType('desk-line');
    },
  },
}
</script>
